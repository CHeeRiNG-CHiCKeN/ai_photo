...
export default function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <div className="interaction-guide" role="note" aria-label="Gesture guide">
        <p>🤏 Pinch fingers to draw</p>
        <p>🙋 Raise hand for sparkles</p>
        <p>💖 Pinch with both hands for hearts</p>
      </div>
